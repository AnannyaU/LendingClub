...
# The feature set includes risk_score
# validation auc = 0.9616347
...
myX <- c("loan_amnt", "term", "emp_length", "annual_inc", "zip_code", "dti", "delinq_2yrs", "risk_score",
...
# auc for training data = 0.9765644
# auc for validation data = 0.9616347
